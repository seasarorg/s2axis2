 ...
 */
package org.seasar.remoting.axis2.examples.ex06;

import java.util.Calendar;
import java.util.Date;

import org.seasar.extension.unit.S2TestCase;
import org.seasar.remoting.axis2.examples.ex01.SimpleWrapTypeService;

/**
 * @author takanori
 */
public class SimpleWrapTypeFormCustomWSDLTest extends S2TestCase {

    private SimpleWrapTypeService service;

    public SimpleWrapTypeFormCustomWSDLTest(String name) {
        super(name);
    }

    public void setUp() {
        include("SimpleWrapTypeFormCustomWSDLTest.dicon");
    }

...
public class ComponentBasedServiceBuilderImpl implements
	...
	private static final Logger logger = Logger
			.getLogger(ComponentBasedServiceBuilderImpl.class);
	...
	public AxisService populateService(ConfigurationContext configCtx,
		...
		try {
			...
			throw new DeployFailedException("EAXS0003", new Object[] { service
					.getName() }, ex);
		}
		...
		Parameter paramServiceObjectSupplier = new Parameter(
				Constants.SERVICE_OBJECT_SUPPLIER, serviceObjectSupplierClass
						.getName());
		try {
